...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: 'website',
      url: `https://fizoval.com/ai-tools/${category}`,
      siteName: 'Fizoval',
      images: [
        {
    ...
    alternates: {
      canonical: `https://fizoval.com/ai-tools/${category}`,
    },
  };
}
...
export default async function CategoryPage({ params }) {
  const { category } = await params;
  return <CategoryToolsPage categorySlug={category} />;
} 