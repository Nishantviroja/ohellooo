  ...
  useEffect(() => {
    async function processData() {
      try {
            ...
            setTimeout(() => {
              ...
              for (let i = startIndex; i < endIndex; i++) {
                ...
                const enhancedTool = {
                  ...
                  category: tool.category || 'Uncategorized' // Keep original category name
                };
                
                processedTools.push(enhancedTool);
                
                // Add to category map with original category names
        ...
        // Shuffle tools for random order on each refresh
