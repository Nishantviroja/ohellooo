...
const RecentlyAddedSection = () => {
  // Get last 8 tools (simulating recently added - in production, you'd sort by date added)
  const recentTools = useMemo(() => {
    return aiTools.slice(-8).reverse();
  }, []);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Recently Added <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">AI Tools</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover the latest AI tools added to our directory this week
          </p>
        </div>
          ...
          {recentTools.map((tool) => (
            ...
            >
              ...
              <div className="relative w-full h-48 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                ...
                {/* New Badge */}
                <div className="absolute top-2 right-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-xs font-bold px-3 py-1 rounded-full">
                  NEW
                </div>
              </div>
